      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden sm:flex items-center space-x-2">
            ...
            <a 
              href="/demo.html" 
              className="px-4 py-2 rounded-lg text-sm font-semibold text-slate-600 hover:text-slate-900 hover:bg-slate-100/80 transition-all duration-150 flex items-center space-x-1"
            >
      ...
      {isMobileMenuOpen && (
        <div className="sm:hidden border-t border-slate-200 bg-white/95 backdrop-blur-lg px-4 pt-3 pb-5 space-y-2 shadow-lg transition-all">
          ...
          <a
            href="/demo.html"
            onClick={closeMobileMenu}
            className="block px-4 py-3 rounded-xl text-sm font-bold text-slate-700 hover:bg-slate-100 transition"
          >
            🌐 Widget Demo Page
          </a>
